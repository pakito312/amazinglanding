(function($) {
    $.cookit = function(options) {
      ...
      var settings = $.extend({
        ...
        linkColor: '#fad04c',
        buttonColor: '#fad04c',
        messageText: "<b>Accepter les cookies et la politique de confidentialité ?</b> En poursuivant votre navigation sur ce site, vous acceptez l'utilisation de cookies.",
